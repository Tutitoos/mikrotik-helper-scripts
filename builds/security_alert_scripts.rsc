...
/ip firewall filter add chain=input protocol=tcp dst-port=22,8291 action=add-src-to-address-list address-list=login_fail_list address-list-timeout=10m connection-state=new log=yes log-prefix="LOGIN-FAIL"
